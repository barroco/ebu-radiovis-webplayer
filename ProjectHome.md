RadioVIS player for Web Browser
(compatible chrome, ie, firefox and safari)

It includes a stomp to comet interface and make the radioDNS resolution.



# Installation #

1. Add your VIS server to the list of authorized servers in rdns-lookup.php file.

2. Use the code below to display it.
...
-->
	...
	<body>
		...
		<script>
			...
			********************************/
			var topic = "/topic/fm/4e1/4000/09580";
